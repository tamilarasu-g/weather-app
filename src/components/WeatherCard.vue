...
<template>
    <div :class="place.current.is_day === 1 ? 'bg-day' : 'bg-night'" class="text-white p-10 rounded-lg shadow-lg gap-6 mb-6 relative overflow-hidden bg-blue-500">
        <!-- Location & time -->
        ...
        <!-- forecast -->
        <div v-for="(day, idx) in place.forecast.forecastday">
